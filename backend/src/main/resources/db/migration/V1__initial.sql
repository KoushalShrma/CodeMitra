-- Baseline schema for Code_Mitra core entities and legacy compatibility endpoints.

CREATE TABLE IF NOT EXISTS users (
  id INT AUTO_INCREMENT PRIMARY KEY,
  clerk_id VARCHAR(191) UNIQUE,
...
SET @sql_users_clerk_id = (
  SELECT IF(
    ...
    'SELECT 1',
    'ALTER TABLE users ADD COLUMN clerk_id VARCHAR(191) UNIQUE'
  )
);
PREPARE stmt_users_clerk_id FROM @sql_users_clerk_id;
EXECUTE stmt_users_clerk_id;
DEALLOCATE PREPARE stmt_users_clerk_id;
